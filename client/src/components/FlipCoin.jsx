...
function FlipCoin() {
    return (
        <>
            <div className="w-full py-[14px] pt-4 lg:pt-[63px] min-h-[80vh]">
                <Link to={"/"} className="px-2 py-3 mb-4 flex items-center gap-1 w-fit">
                ...
                <div className="flex flex-col gap-[56px] ">
                    <div className="min-h-[82px]  flex-col justify-start items-center gap-[15px] inline-flex">
                        <div className="text-[36px] lg:text-[44px] font-extrabold font-['Roboto'] flex justify-center flex-wrap uppercase leading-[43px] gap-3">
                    ...
                    <div className="grid 3xl:grid-cols-3 lg:grid-cols-2 gap-[21px]">
